...
public class PersonController implements PersonControllerDocs {
    ...
    public ResponseEntity<Resource> exportPage(
        ...
        var contentType = acceptHeader != null ? acceptHeader : "application/octet-string";
        var fileExtension = MediaTypes.APPLICATION_XLSX_VALUE.equalsIgnoreCase(acceptHeader) ? ".xlxs" : ".csv";
...
//    @CrossOrigin(origins = {"http://localhost:8080","https://onesys.com.br"})
