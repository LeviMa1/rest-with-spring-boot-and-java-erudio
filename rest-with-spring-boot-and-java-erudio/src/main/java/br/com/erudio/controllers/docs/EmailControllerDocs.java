...
public interface EmailControllerDocs {
    ...
    @Operation(summary = "Send and e-Mail", description = "Sends an e-Mail by providing details, subject and body.",
            tags = {"e-Mail"}, responses = {
    ...
    @Operation(summary = "Send and e-Mail with Attachment", description = "Sends an e-Mail with Attachment by providing details, subject and body.",
            tags = {"e-Mail"}, responses = {
            @ApiResponse(description = "Success", responseCode = "200", content = @Content),
            @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
            @ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
